...
//in the code (sentenceCode >= MAX_CODE) its suppose to be (sentenceCode > MAX_CODE)because its not suppose to equal 5 because 5 is a valid sentence code.
//in the line of code }else; if( modifierCode == 3 ){ the ; is not suppose to be there after else if the ; is there then it ends the statement.
//in the code if(m == 2); in the weather modifier there is not suppose to ve a ; because then it would not run word ="foggy". 
